...
public class StartScreen extends VBox {
    ...
    public StartScreen(SwapPane parent, MenuBar menuBar) {
        ...
        zoomToSubMenu.getItems().addAll(
                        zoomPercent25, zoomPercent50, zoomPercent75,
                        zoomPercent100, zoomPercent150, zoomPercent200,
                        zoomPercent300, zoomPercent400);
        ...
        setPageOnlyMenuItems(closePageItem, savePageItem, savePageAsItem,
                        zoomToSubMenu, zoomInItem, zoomOutItem, resetItem);
        setPageOnlyMenu(viewMenu);

        viewMenu.getItems().addAll(
                        zoomToSubMenu, zoomInItem, zoomOutItem,
                        resetItem, centerItem);
